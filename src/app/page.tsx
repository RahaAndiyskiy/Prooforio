  ...
  return (
    <section className="rounded-[20px] border border-[var(--pf-border-strong)] bg-surface/85 px-4 py-5 shadow-card backdrop-blur-xl">
      ...
      <div className="mt-6 grid gap-3">
        ...
        <Link href="/dashboard" className="pf-press flex h-11 items-center justify-center rounded-full bg-control text-[14px] font-semibold text-primary shadow-control ring-1 ring-[var(--pf-border-soft)]">
          Панель
        </Link>
      </div>
    </section>
