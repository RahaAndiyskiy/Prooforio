...
export function CreamPlumTemplate({ content, dimensions, preset, review }: ReviewExportPresetRenderContext) {
        ...
        >
          ...
          <div
            style={{
              ...
              fontWeight: 400,
              fontSize: Math.round((isSquareFormat ? 18 : 16) * scale),
              color: tokens.footerMetaColor,
              lineHeight: 1.3,
              opacity: 0.8,
            }}
          >
