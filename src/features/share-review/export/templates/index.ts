...
const presetDefinitions: ReviewExportPresetDefinition[] = [
  ...
  },
  {
    id: 'instagram-pop',
    label: 'Instagram Pop',
    description: 'Яркая квадратная карточка с градиентом, крупным именем автора и выразительной типографикой.',
    meta: {
      format: 'square',
      styleId: 'instagram-pop',
      layoutId: 'hero-top',
      fontPackId: 'neutral-sans',
      tags: ['bright', 'gradient', 'instagram', 'square', 'social'],
      featured: true,
      order: 32,
    },
  },
